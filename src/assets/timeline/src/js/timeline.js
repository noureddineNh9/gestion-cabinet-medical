export function timeline(collection, options) {
      ...
      function setHeights() {
         ...
         tl.items.forEach((item, i) => {
            ...
            if (i % 2 === 0) {
               ...
               oddIndexTallest =
                  height > oddIndexTallest ? height : oddIndexTallest;
            }
         });
   ...
   function slideTimeline(tl) {
      ...
      const arrowPrev = tl.timelineEl.querySelector(
         ".timeline-nav-button--prev"
      );
      const arrowNext = tl.timelineEl.querySelector(
   ...
   function resetTimelines(tl) {
      tl.timelineEl.classList.remove(
         "timeline--horizontal",
         "timeline--mobile"
      );
